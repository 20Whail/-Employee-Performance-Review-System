...
#   private
#   def user_params
#     serialized_params = params.require(:user).permit(:first_name, :last_name, :phone,:password,:password_confirmation,
#                                                      :email, :role, :joining_date, :assigned_manager)
#     serialized_params[:user][:role] = params[:user][:role].to_i if params.has_key?(:user)
#     serialized_params
#   end
# end